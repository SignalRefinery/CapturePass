...
const STATIC_TITLES: Record<string, SocialImageData> = {
  "/": { title: "TapTagg", subtitle: "Play Tagg Everywhere." },
  "/business": { title: "TapTagg for Business", subtitle: "Contact capture, reusable profiles, and lead ownership." },
  ...
  "/pricing": { title: "TapTagg Pricing", subtitle: "Digital sharing, contact capture, and team tools." },
  "/resources": { title: "TapTagg Resources", subtitle: "Guides for NFC cards and lead capture." },
  "/dealerships": { title: "TapTagg for Dealerships", subtitle: "Lead capture and showroom follow-up." },
  "/insurance-agents": { title: "TapTagg for Insurance Agents", subtitle: "Referral networking and long-term follow-up." },
  "/real-estate-agents": { title: "TapTagg for Real Estate Agents", subtitle: "Open houses, listings, and saved contacts." },
  "/sales-teams": { title: "TapTagg for Sales Teams", subtitle: "Lead ownership and team accountability." },
  ...
  "/taptagg-vs-popl": { title: "TapTagg vs Popl", subtitle: "A focused comparison for sales teams and local businesses." },
  "/contact": { title: "Contact TapTagg", subtitle: "Talk with TapTagg about business cards and lead capture." }
};
...
export function getSocialImageData(
  ...
  if (overrides?.title || overrides?.subtitle) {
    return {
      ...
      title: overrides.title || STATIC_TITLES[pathname]?.title || "TapTagg"
    };
  }
