...
type AccountLogoSectionProps = {
  brandLogoUrl?: string | null;
  displayName?: string | null;
};

export function AccountLogoSection({ brandLogoUrl, displayName }: AccountLogoSectionProps) {
  ...
  return (
    <div className="card" style={{ padding: 26 }}>
      ...
      <p className="editor-copy">
        Upload a PNG logo for your public profile and pass pages. This is the logo people will see instead of the default avatar block.
      </p>

      <form className="editor-form" onSubmit={handleSave} style={{ marginTop: 18 }}>
        <label className="editor-label">
          ...
          {logoUrl ? (
            <div className="business-logo-preview">
              ...
              <img src={logoUrl} alt={`${displayName || "Business"} logo`} />
