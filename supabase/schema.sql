...
create table if not exists public.profiles (
  ...
  primary_link_2_title text not null default 'Website',
  primary_link_2_url text not null default '',
  primary_link_3_title text not null default 'Text',
  primary_link_3_url text not null default '',
  primary_link_4_title text not null default 'Download contact card',
