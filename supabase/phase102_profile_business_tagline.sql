-- Add a short public-facing business tagline to the profile hero.
--
-- The tagline appears above the profile name on public pages and can be used
-- instead of the default "Live profile" label.

alter table public.profiles
  add column if not exists business_tagline text;

comment on column public.profiles.business_tagline
is 'Optional short tagline shown above the public profile name.';
...
is 'Returns the limited public profile payload for active, visible, approved slug pages, including business tagline and secondary button mode.';
