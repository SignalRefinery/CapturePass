...
export default async function BusinessDashboardPage({
  ...
  if (isPlatformAdmin && !selectedOrganizationId && !showOnboarding) {
    return (
      <Shell footerLeft="Business dashboard" footerRight="CapturePass" initialAuth={initialAuth} navLinks={businessNavLinks} pageVariant="light">
  ...
  if (isLocationScopedViewer) {
    return (
      <Shell footerLeft={dashboardFooterLeft} footerRight="CapturePass" initialAuth={initialAuth} navLinks={businessNavLinks} pageVariant="light">
