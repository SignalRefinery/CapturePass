...
const page = getSpringfieldPage("springfield-il-sales-team-business-cards");

export const metadata = buildPageMetadata({
  description: page?.description || "",
  path: "/springfield-il-sales-team-business-cards",
  title: page?.title || "Springfield Sales Team Business Cards"
});

export default function SpringfieldSalesTeamBusinessCardsPage() {
  if (!page) return null;
